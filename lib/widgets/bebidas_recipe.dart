...
Widget recipeBebidas(){
  return Container(
    ...
    ListView.builder(
      ...
      shrinkWrap: true,
      itemCount: RecipeModel.bebidasRecipe.length,
          ...
          child: GestureDetector(
              onTap: ()=> Navigator.push(
                ...
                MaterialPageRoute(
                  builder: (context)=>
                      RecipeDetails(
                        recipeModel: RecipeModel.bebidasRecipe[index],
                      ),
                ),
              ),
              child: RecipeCard(RecipeModel.bebidasRecipe[index])
          ),
        );
      },
    ),
