...
Widget recipeBolosTortas(){
  return Container(
    ...
    ListView.builder(
      ...
      shrinkWrap: true,
      itemCount: RecipeModel.bolosTortasRecipe.length,
          ...
          child: GestureDetector(
              onTap: ()=> Navigator.push(
                ...
                MaterialPageRoute(
                  builder: (context)=>
                      RecipeDetails(
                        recipeModel: RecipeModel.bolosTortasRecipe[index],
                      ),
                ),
              ),
              child: RecipeCard(RecipeModel.bolosTortasRecipe[index])
          ),
        );
      },
    ),
