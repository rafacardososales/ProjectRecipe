...
Widget recipeSalgadas(){
  return Container(
    ...
    ListView.builder(
      ...
      shrinkWrap: true,
      itemCount: RecipeModel.salgadasRecipe.length,
          ...
          child: GestureDetector(
              onTap: ()=> Navigator.push(
                ...
                MaterialPageRoute(
                  builder: (context)=>
                      RecipeDetails(
                        recipeModel: RecipeModel.salgadasRecipe[index],
                      ),
                ),
              ),
              child: RecipeCard(RecipeModel.salgadasRecipe[index])
          ),
        );
      },
    ),
