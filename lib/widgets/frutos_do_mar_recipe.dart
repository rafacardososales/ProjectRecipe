...
Widget recipeFrutosDoMar(){
  return Container(
    ...
    ListView.builder(
      ...
      shrinkWrap: true,
      itemCount: RecipeModel.frutosDoMarRecipe.length,
          ...
          child: GestureDetector(
              onTap: ()=> Navigator.push(
                ...
                MaterialPageRoute(
                  builder: (context)=>
                      RecipeDetails(
                        recipeModel: RecipeModel.frutosDoMarRecipe[index],
                      ),
                ),
              ),
              child: RecipeCard(RecipeModel.frutosDoMarRecipe[index])
          ),
        );
      },
    ),
