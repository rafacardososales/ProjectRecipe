...
Widget recipeSaladas(){
  return Container(
    ...
    ListView.builder(
      ...
      shrinkWrap: true,
      itemCount: RecipeModel.saladasRecipe.length,
          ...
          child: GestureDetector(
              onTap: ()=> Navigator.push(
                ...
                MaterialPageRoute(
                  builder: (context)=>
                      RecipeDetails(
                        recipeModel: RecipeModel.saladasRecipe[index],
                      ),
                ),
              ),
              child: RecipeCard(RecipeModel.saladasRecipe[index])
          ),
        );
      },
    ),
